...
namespace platform
{
    public class TextOSerialize : ISerialize
    {
        ...
        public void _openUrl(string nUrl)
        {
            ...
            mStreamWriter = new StreamWriter(path_);
        }
        ...
        void _writeString(string nValue)
        {
            UTF8Encoding encode_ = new UTF8Encoding();
            foreach (char i in nValue)
            {
                mStreamWriter.Write(i);
            }
            mStreamWriter.Write(32);
        }

        public TextOSerialize()
        {
            mStreamWriter = null;
        }
